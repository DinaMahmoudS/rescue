          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                trailing:
                    Text("02 37250031", style: TextStyle(color: Colors.black)),
              ),
              ListTile(
                ...
                subtitle: const Text(
                    ...
                    style: TextStyle(color: Colors.black)),
                trailing:
                    Text("02 21600194", style: TextStyle(color: Colors.black)),
              ),
              ListTile(
                ...
                title: const Text("Kia",
                    style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.bold)),
                subtitle: const Text(
                    "بركة النصر، قسم أول السلام، محافظة القاهرة",
                    style: TextStyle(color: Colors.black)),
                trailing:
                    Text("02 35391481", style: TextStyle(color: Colors.black)),
              ),
              ListTile(
                leading: Image.asset(
                    "assets/car_agency/BMW_logo_(gray).svg.png",
                    height: 100,
                    width: 100,
                    fit: BoxFit.fill),
              ...
              ListTile(
                ...
                title: const Text("toyota",
                    style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.bold)),
                trailing:
                    Text("02 24883500", style: TextStyle(color: Colors.black)),
                subtitle: const Text(
